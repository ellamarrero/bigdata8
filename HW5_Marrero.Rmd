...
The tree is  shaped like this because `twotwo` is a binary variable indicating indicating if the number of bedrooms and bathrooms for a house are both at least two. Thus the first break likely corresponds to houses where either bedrooms or bathrooms are not both at least two, and the next node on the opposite leaf is determining if num. bedroom and bathroom both > 2. (???)
