...
The KNN model looks better than the logit probability model because there is more area under in-sample ROC curve, indicating that for a given probability threshold, the KNN model is better at correctly classifying y. It also appears that the KNN model improves a lot with a relatively small increase to the probability threshold, with 0.2 as a max.  
