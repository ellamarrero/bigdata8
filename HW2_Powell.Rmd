...
While the model with interactions has a lower $R^2$ we would 
...
The model seems to actually fit the data relatively well where log price is between about 12 and 14. However, there is a massive amount of variance in the residuals as well as a large number of outliers leaving this model somewhat tenuous. 
